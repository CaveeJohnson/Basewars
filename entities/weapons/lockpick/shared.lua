...
function SWEP:PrimaryAttack()
	...
	if (IsValid(trace.Entity)) then	
		...
		elseif (trace.HitPos:Distance(self.Owner:GetShootPos()) <= 75 and trace.Entity:IsDoor() and IsValid(trace.Entity)) then
			self.Weapon:SendWeaponAnim(ACT_VM_HITCENTER)
			self.Owner:FireBullets(bullet) 
			self.Weapon:EmitSound("physics/flesh/flesh_impact_bullet" .. math.random( 3, 5 ) .. ".wav")
		...
		elseif (trace.HitPos:Distance(self.Owner:GetShootPos()) <= 75 and (trace.Entity:GetClass()=="gunvault" || trace.Entity:GetClass()=="pillbox") and IsValid(trace.Entity)) then
			self.Weapon:SendWeaponAnim(ACT_VM_HITCENTER)
			self.Owner:FireBullets(bullet) 
			self.Weapon:EmitSound("physics/flesh/flesh_impact_bullet" .. math.random( 3, 5 ) .. ".wav")
		...
		elseif (self.Owner:GetTable().Tooled && trace.HitPos:Distance(self.Owner:GetShootPos()) <= 75 and (trace.Entity:GetClass()=="sent_keypad") and IsValid(trace.Entity)) then
			self.Weapon:SendWeaponAnim(ACT_VM_HITCENTER)
			self.Owner:FireBullets(bullet) 
			self.Weapon:EmitSound("physics/flesh/flesh_impact_bullet" .. math.random( 3, 5 ) .. ".wav")
