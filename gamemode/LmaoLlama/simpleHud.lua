function myhud()
    ...
    draw.SimpleText("Health: "..client:Health() .. "%", "default", 35, ScrH()-100, Color(250, 230, 10, 255), 0, 0)
    draw.SimpleText("Armor: "..client:Armor().."%","default",35,ScrH()-65,Color(5,150,255,255),0,0)
    ...
    draw.SimpleText("Clock: "..tostring(os.date()),"default",ScrW()-200,ScrH()-50,Color(220,220,220,255),0,0)
    draw.SimpleText("Ping: "..client:Ping(),"default",35,ScrH()-128,Color(250,230,0,255),0,0)
    ...
    draw.SimpleText("Mag: "..mag_left , "default", 240, ScrH()-100, Color(0, 220, 0, 255*hasprim), 0, 0)
    draw.SimpleText(mag_extra , "default", 380, ScrH()-100, Color(0, 220, 0, 255*hasprim), 0, 0)
    ...
    draw.SimpleText("Sec: "..secondary_ammo , "default", 240, ScrH()-55, Color(220, 0, 0, 255*hassec), 0, 0)
